...
function LoginContent() {
    ...
    const [error, setError] = useState<string | null>(
        errorParam === "expired" ? "Your link has expired. Please sign in again." :
            errorParam === "auth_failed" ? "Authentication failed. Please try again." :
                errorParam === "no_account" ? "No account found. Please sign up first." :
                    null
    );
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Open WhatsApp with pre-filled "Sign in" message
    ...
    const signupHref = phoneNumber ? `/signup?phone=${encodeURIComponent(phoneNumber)}` : "/signup";

    return (
        <Card className="border-none shadow-none bg-transparent px-0 sm:px-8">
            <div className="mb-10">
                <Link href="/" className="inline-flex items-center text-lg font-bold text-zinc-500 hover:text-black transition-colors mb-6">
            ...
            <div className="mt-8 text-center">
                <p className="text-zinc-500 font-medium">
                    ...
                    <Link href={signupHref} className="text-black hover:underline font-bold">
                        Sign up
                    </Link>
                </p>
            </div>

...
const MODAL = {
    ...
    body: "p-5 sm:p-6 overflow-y-auto flex-1 bg-white overscroll-contain pb-[calc(1.25rem+env(keyboard-inset-height,0px))] sm:pb-[calc(1.5rem+env(keyboard-inset-height,0px))]",
    footer: "p-5 sm:p-6 border-t border-gray-100 bg-white sm:bg-gray-50/50 mt-auto relative z-20 pb-[calc(2rem+env(keyboard-inset-height,0px))] sm:pb-6 shrink-0",
